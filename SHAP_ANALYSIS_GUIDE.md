...
This guide explains how to perform SHAP (SHapley Additive exPlanations) feature importance analysis on any trained model in the nitrate (NO3) pipeline.
...
3. **Training Data Extraction**
   ...
   - Extracts descriptive feature names from pipeline (N_I_primary_simple_peak_area, etc.)
...
N_I_primary_simple_peak_area,0.123456,15.2,15.2
N_I_primary_simple_peak_height,0.098765,12.1,27.3
...
```
...
3. **Ratio Features** (High robustness)
   - N/C ratio: Nitrogen relative to carbon
   - N/O ratio: Nitrogen relative to oxygen (nitrate indicator)
   - N/H ratio: Nitrogen relative to hydrogen (ammonium vs nitrate)
   - Cross-element interactions

### Common Insights

- **Top feature importance:** Often N (nitrogen) peaks and N/O, N/H ratios dominate for nitrate prediction
