...
This is a machine learning pipeline for predicting nitrate (NO3) concentration from LIBS (Laser-Induced Breakdown Spectroscopy) spectral data. The pipeline processes spectral intensity measurements at specific wavelengths to predict nitrate concentration in samples (typically soil).
...
- **Feature Engineering** (`src/features/`): Three strategies - N_only (nitrogen peaks), simple_only (basic features), full_context (all spectral regions)
...
- **N_only**: Focus on nitrogen spectral regions (742-747nm primary, 821-824nm and 868-871nm secondary)
- **simple_only**: Basic spectral features without complex transformations
- **full_context**: All spectral regions including C, H, O, N, P molecular bands (CN, NH, NO), and supporting elements
