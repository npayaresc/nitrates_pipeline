...
class Reporter:
    ...
    def save_summary_report(self, strategy: str = None, model_name: str = None):
        ...
        display_cols = ['strategy', 'model_name', 'r2', 'rmse', 'mae', 'mape', 'rrmse', 'within_20.5%', 'within_10.5%']
    ...
    def generate_calibration_plot(self, predictions_df: pd.DataFrame, strategy: str, model_name: str):
        ...
        plt.xlabel('Actual Nitrate Concentration (%)', fontsize=12)
        plt.ylabel('Predicted Nitrate Concentration (%)', fontsize=12)
        plt.legend()
