"""
Classification Helper Functions for Nitrate Pipeline

This module provides utilities for converting the regression pipeline to classification,
specifically for binary classification of nitrate levels (above/below threshold).
"""
...
def create_binary_labels(y_values, threshold=0.3):
    """
    Convert continuous nitrate values to binary labels.

    Args:
        y_values: Array or Series of nitrate concentration values
...
def calculate_class_weights(y_train, method='balanced'):
    ...
    if method == 'balanced':
        ...
        # Custom weights based on nitrate importance
        ...
        # Additional adjustment: High nitrate (>=0.3) is agronomically important
