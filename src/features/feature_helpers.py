...
# ============================================================================
# OLD POTASSIUM PREDICTION CODE - COMMENTED OUT (DEAD CODE)
# These functions were from the original potassium prediction pipeline
# and have been replaced by the nitrogen-based versions below (lines 266+)
# ============================================================================
